...
def banner():
    ...
    print('       |     \     |       |        |    ')
    print('       |      \     -------    -----|    ')
    print('                                                 - By Mayank Garg (Alphaxlegion)')
    print('                                         ')
...
def parseArgs():
    p = argparse.ArgumentParser(description="ROS - Reconnaissance One Stop")
...
if __name__ == '__main__':
    ...
    if "--version" in sys.argv:
        print("\nReconnaissance One Stop v" + str(program_version) + " - By Mayank Garg")
        print("Contact me: https://github.com/alphaxlegion/ROS\n")
        sys.exit(0)
